                                            ...
                                            <tbody>
                                                <form method="post">
                                                    	<tr>
                                                            ...
                                                            <th scope="row"><label for="idDrug">Drug Id Number</label></th>
                                                            <td><input type="text" name="idDrug" id="idDrug"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th scope="row"><label for="interation">Interaction</label></th>
                                                            <td><select name="interaction"><
